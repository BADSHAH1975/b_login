import 'package:b_sell/popup_screens.dart/pan_otp.dart';
...
class _PanNumberState extends State<PanNumber> {
  ...
  Container buildSignupSection() {
    return Container(
      ...
      child: const Column(
        children: [
          // buildTextField(Icons.credit_score, "Pan Number", false, true),
          ...
          child: InkWell(
            onTap: () {
              setState(() {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => const PanOtp()),
                );
              });
            },
            child: Container(
              ...
              child: Container(
                decoration: BoxDecoration(
                    gradient: LinearGradient(
                        colors: [Colors.deepPurple[200]!, Colors.blue[900]!],
