import 'package:b_sell/screens/details_page.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';

class AdharOtp extends StatefulWidget {
  const AdharOtp({super.key});
  ...
  Container buildSignupSection() {
    return Container(
      ...
      child: Column(
        children: [
          buildTextField(
              Icons.mobile_friendly, "Adhar Number OTP", false, true),
          ...
          child: GestureDetector(
            onTap: () {
              setState(() {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => const ManiPage()),
                );
              });
            },
            child: Container(
